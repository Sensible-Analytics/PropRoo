...
test.describe('PropRoo DuckDB-WASM E2E Test Suite', () => {
  ...
  test.describe('1. Initialization', () => {
    ...
    test('app transitions from loading to main UI with NSW breadcrumb', async ({ page }) => {
      await expect(page.locator('text=PROPERTY TYPE')).toBeVisible({ timeout: 60000 });
    });
  ...
  test.describe('2. Map Rendering', () => {
    ...
    test('year display shows current year', async ({ page }) => {
      ...
      await expect(page.locator('text=PROPERTY TYPE')).toBeVisible({ timeout: 60000 });
      // Year display uses text-2xl.font-black class
      const yearDisplay = page.locator('.text-2xl.font-black');
  ...
  test.describe('5. Navigation & Drill-Down', () => {
    ...
    test('back button returns to state level', async ({ page }) => {
      ...
      await page.waitForTimeout(3000);
      await expect(page.locator('text=PROPERTY TYPE')).toBeVisible({ timeout: 10000 });
    });
  });
  ...
  test.describe('9. Map-Driven Hierarchical Exploration', () => {
    ...
    test('back button navigates up the hierarchy', async ({ page }) => {
      ...
      await expect(page.locator('text=PROPERTY TYPE')).toBeVisible({ timeout: 15000 });
    });
  ...
  test.describe('15. New UI Features (80/20 Layout, Breadcrumb, Attribution)', () => {
    ...
    test('data attribution overlay is visible on map', async ({ page }) => {
      ...
      await expect(page.locator('text=PROPERTY TYPE Valuer General')).toBeVisible({ timeout: 10000 });
    });
